...
export function ChatWindow({
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      <form
        onSubmit={handleSend}
        className="flex shrink-0 items-center gap-2 px-4 pt-3 pb-3 supports-[-webkit-touch-callout:none]:pb-[calc(0.75rem+env(safe-area-inset-bottom))] shadow-[inset_0_1px_0_0_var(--border)]"
      >
        <input
          type="text"
          value={input}
