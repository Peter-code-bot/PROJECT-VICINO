 ...
 *
 * chat/page.tsx YA consume esta accion: es el unico camino por el que se abre
 * una conversacion desde la ficha de producto. `getOrCreateChat` sigue vivo
 * para `avisarCitaEnChat`, que abre chat sin intencion de compra.
 * Contrato completo en docs/CONTRATO-iniciar-conversacion.md.
 */
