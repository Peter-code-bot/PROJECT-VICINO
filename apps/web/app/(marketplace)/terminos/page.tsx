    ...
    <div className="max-w-3xl mx-auto px-4 py-8 md:py-12">
      ...
      <div className="prose prose-neutral dark:prose-invert prose-sm max-w-none space-y-6">
        ...
        <section>
          ...
          <p>Aunque la Plataforma permite a los vendedores exhibir en su perfil los métodos de pago que aceptan (como efectivo, tarjetas, MercadoPago, etc.), esta función es puramente informativa. Los acuerdos de precio, método de pago real, forma de entrega y cualquier otra condición de la transacción se negocian y acuerdan directamente entre comprador y vendedor a través del sistema de chat y confirmación mutua de la Plataforma.</p>
        </section>
        ...
        <section>
          <h2 className="text-lg font-heading font-bold">8. Comunidades Universitarias</h2>
          <p>VICINO ofrece espacios dedicados a comunidades universitarias. Para acceder a estas funciones, el usuario debe proporcionar y validar información veraz que acredite su pertenencia a dicha comunidad (por ejemplo, correo electrónico institucional con terminación .edu.mx o su identificación/ID universitario).</p>
          <p>El uso indebido de las comunidades universitarias, como la suplantación de identidad, la falsificación de credenciales o el comportamiento inapropiado dentro de estos espacios, resultará en la expulsión inmediata de la comunidad y la posible suspensión definitiva de la cuenta en la Plataforma.</p>
        </section>

        <section>
          <h2 className="text-lg font-heading font-bold">9. Limitación de Responsabilidad</h2>
        ...
        <section>
          <h2 className="text-lg font-heading font-bold">10. Propiedad Intelectual</h2>
        ...
        <section>
          <h2 className="text-lg font-heading font-bold">11. Disputas entre Usuarios</h2>
        ...
        <section>
          <h2 className="text-lg font-heading font-bold">12. Ley Aplicable y Jurisdicción</h2>
        ...
        <section>
          <h2 className="text-lg font-heading font-bold">13. Contacto</h2>
        ...
        <section>
          <h2 className="text-lg font-heading font-bold">14. Reportes, Bloqueo y Conducta del Usuario</h2>
        ...
        <section>
          <h2 className="text-lg font-heading font-bold">15. Seguridad Infantil y Denuncias</h2>
