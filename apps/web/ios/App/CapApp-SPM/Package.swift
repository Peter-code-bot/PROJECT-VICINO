...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorNetwork", path: "..\..\..\..\..\node_modules\.pnpm\@capacitor+network@8.0.1_@capacitor+core@8.3.0\node_modules\@capacitor\network"),
        .package(name: "CapacitorPushNotifications", path: "..\..\..\..\..\node_modules\.pnpm\@capacitor+push-notifications@8.1.1_@capacitor+core@8.3.0\node_modules\@capacitor\push-notifications"),
