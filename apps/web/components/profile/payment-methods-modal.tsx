          ...
          {metodos.length > 0 ? (
            metodos.map((metodo) => {
              ...
              return (
                <div
                  key={metodo}
                  className="flex items-center gap-3.5 p-3.5 rounded-2xl bg-black/[0.02] dark:bg-white/[0.03] border border-black/5 dark:border-white/10 transition-colors"
                >
                  <div className="w-11 h-11 rounded-full bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 flex items-center justify-center shrink-0">
