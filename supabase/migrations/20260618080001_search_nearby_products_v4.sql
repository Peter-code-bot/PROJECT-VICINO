-- Migración: search_nearby_products_v4 (V4 Principal)
-- Propósito: RPC unificado para búsqueda hiperlocal con paginación Keyset atómica,
-- modo universidad, y soporte para PostgREST.
